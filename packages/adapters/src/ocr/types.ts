...
export interface DocumentMetadata {
     ...
     * provider does not report one — never fabricated (ADR-004).
     */
 ...
 *
 * "MARKER" was removed (ADR-004): it never had a real implementation and
 * silently aliased Docling. Use "DOCLING".
 */
...
export interface OCRAdapter {
     ...
     */
    uploadDocument(documentUrl: string, options?: OCRAdapterOptions): Promise<NormalizedDocument>;
