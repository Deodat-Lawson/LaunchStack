...
export const SESSION_TOOLS = ["claude-code", "codex"] as const;

export type SessionToolId = (typeof SESSION_TOOLS)[number];

export function sessionToolLabel(toolId: SessionToolId): string {
...
export type TranscriptSegment =
    | { readonly kind: "user"; readonly text: string; readonly at?: string }
    | { readonly kind: "assistant"; readonly text: string; readonly at?: string }
