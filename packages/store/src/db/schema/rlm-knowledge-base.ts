...
/**
 * UNUSED as of ADR-004 §5. The experimental embedding pipeline that wrote and
 * queried this table (apps/web/src/lib/embeddings/experimental and the
 * /api/experimental/embedding-search route) targeted the phantom
 * ${SIDECAR_URL}/embed endpoint and was deleted. The table stays because
 * migrations are additive-only — never drop it; a future services/inference
