import type { SourceAdapterOptions, StandardizedDocument, StandardizedPage } from "../types";
...
export function processGitHubExport(
    ...
    console.log(`[GitHubExportAdapter] Processing ${items.length} ${kind} from ${repoName}`);
