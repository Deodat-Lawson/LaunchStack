...
ALTER TABLE "pdr_ai_v2_email_campaigns" ADD CONSTRAINT "pdr_ai_v2_email_campaigns_company_id_pdr_ai_v2_company_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."pdr_ai_v2_company"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "pdr_ai_v2_email_suppressions" ADD CONSTRAINT "pdr_ai_v2_email_suppressions_company_id_pdr_ai_v2_company_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."pdr_ai_v2_company"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
