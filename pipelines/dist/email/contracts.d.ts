import type { EmailTemplate, Recipient, RenderedEmail, TemplateReview } from "./types.js";
/**
...
export type MergeFn = (template: EmailTemplate, recipient: Recipient) => RenderedEmail;
/**
