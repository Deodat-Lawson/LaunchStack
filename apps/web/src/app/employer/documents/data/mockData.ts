...
export const mockChatHistory: ChatHistory[] = [
    {
        ...
        messages: [
            ...
            },
            {
                ...
                role: "assistant",
                content:
                    "The chapter discusses several key ethical principles including professional responsibility, public safety, and the importance of transparency in engineering decisions.",
