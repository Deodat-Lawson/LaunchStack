    ...
    return (
        ...
        >
            <span
                ...
                style={{
                    background: "color-mix(in oklch, var(--panel, white) 88%, transparent)",
            ...
            >
                ...
                <span className="flex items-center gap-2">
                    <Sparkles className="h-3 w-3" style={{ color: "var(--inline-accent)" }} />
                    <span
                        style={{
                            fontFamily: monoFont,
                            fontSize: 10,
...
function btnStyle(variant: "accent" | "outline" | "ghost", disabled: boolean): React.CSSProperties {
