...
export const MainDeployment: React.FC<DeploymentProps> = ({ copyToClipboard, copiedCode }) => {
    return (
        <>
            ...
            <Section title="Get started" subtitle="Four accounts to create before your first boot.">
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    ...
                    <StepCard
                        ...
                        body={
                            <>
                                Google Gemini by default — or any endpoint speaking the OpenAI
                                chat-completions protocol. Details on the{" "}
                    ...
                    <StepCard
                        ...
                        body={
                            <>
                                ...
                                for serverless, or run the bundled{" "}
                                <code className={styles.mono}>postgres + pgvector</code> container
                                for self-hosting.
                            </>
                        }
                    />
                    <StepCard
                        ...
                        body={
                            <>
                                Storage → <strong>Create Database → Blob</strong> in your Vercel
                                project. The connector injects{" "}
                                <code className={styles.mono}>BLOB_READ_WRITE_TOKEN</code>{" "}
                                automatically.
                            </>
                        }
                    />
            ...
            <div id="quick-start" />
            <Section title="Quick start" subtitle="Run the app on your machine in five commands.">
                <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
                    ...
                    <Step
                        ...
                        onCopy={() =>
                            copyToClipboard("pnpm --filter @launchstack/core db:migrate", "qs-4")
                        }
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14, marginBottom: 24 }}>
                <div className={styles.calloutWarn}>
                    ...
                    />
                    <div>
                        <strong>Keep secrets out of git.</strong> Commit only{" "}
                        <code className={styles.mono}>.env.example</code>. Put real keys in your
                        deploy platform&rsquo;s environment variable manager.
                    </div>
                </div>
