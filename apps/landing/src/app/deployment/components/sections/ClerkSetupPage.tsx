...
export const ClerkSetupPage: React.FC<DeploymentProps> = ({ copyToClipboard, copiedCode }) => {
            ...
            <Section title="Create and configure Clerk">
                <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
                    <Step
                        ...
                        onCopy={() =>
                            copyToClipboard(
                                "Create a new Clerk application instance for Launchstack.",
                                "clerk-step-1"
                            )
                        }
            ...
            <Section title="Common misconfigurations">
                <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                    <InfoBox title="Use live keys in production" icon={<Settings size={18} />}>
                        <p style={{ margin: 0 }}>
                            Test keys can produce inconsistent auth behavior for real users. Make
                            sure production uses your Clerk publishable key and Clerk secret key.
                        </p>
                    </InfoBox>
                    <WarningBox
