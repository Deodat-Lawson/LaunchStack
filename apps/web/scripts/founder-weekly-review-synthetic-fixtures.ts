    ...
    partial: make([
        {
            ...
            sourceId: "synthetic:doc:release",
            title: "Release notes",
            sourceTimestamp: "2026-02-20T12:00:00.000Z",
            excerpt: "Export filtering was released.",
            metadata: { fixture: "synthetic-v1" },
        },
        {
            sourceType: "founder_context",
            sourceId: "synthetic:context:priority",
            title: "Founder context",
            excerpt: "Prioritize onboarding reliability.",
            metadata: { fixture: "synthetic-v1" },
        },
    ]),
    full: make([
        ...
        },
        {
            ...
            sourceId: "synthetic:feedback:export",
            title: "Customer feedback",
            sourceTimestamp: "2026-02-21T12:00:00.000Z",
            excerpt: "A customer requested saved export filters.",
            metadata: { fixture: "synthetic-v1" },
        },
        {
            sourceType: "founder_context",
