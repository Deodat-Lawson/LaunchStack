...
export { TEMPLATE_REGISTRY, type LegalTemplate, type TemplateField } from "./template-registry";
export { buildEditorSections, type EditorSection } from "./section-builders";
