        ...
        <>
            ...
            >
                ...
                <p className={styles.heroSub}>
                    Transcription runs on Gemini; speech generation on Google Cloud Text-to-Speech.
                    Both use the same GOOGLE_AI_API_KEY as the rest of the deployment — no separate
                    voice vendor, and no service account. The key&apos;s project needs the Cloud
