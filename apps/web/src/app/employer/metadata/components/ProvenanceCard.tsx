...
export function ProvenanceCard({
    ...
    const chunksLabel = totalChunks && totalChunks > 0 ? `· ${totalChunks} chunks` : "";
    ...
    return (
        <div className={m.prov}>
            ...
            <div>
                ...
                <div className={m.provDetail}>
                    {detail ? `${detail} · ` : ""}
                    {provenance.extraction_version ? `v${provenance.extraction_version}` : ""}
            ...
            <div>
                ...
                <div className={m.provDetail}>Manual edits override AI on re-extract.</div>
            </div>
        </div>
    );
}
