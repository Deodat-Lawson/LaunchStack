...
import { bigint, doublePrecision, index, integer, jsonb, text, timestamp, varchar, } from "drizzle-orm/pg-core";
...
export const clientProspectorJobs = pgTable("client_prospector_jobs", {
    // ── Primary key ──────────────────────────────────────────────────
...
table => ({
    ...
    companyStatusIdx: index("client_prospector_jobs_company_status_idx").on(table.companyId, table.status),
}));
