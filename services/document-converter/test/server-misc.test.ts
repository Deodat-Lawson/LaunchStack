...
import { postJson, getJson, startApp, testConfig, type TestServer } from "./helpers.js";
...
describe("POST /render-pages", () => {
    it("translates 0-based wire indices to 1-based pdf2pic pages", async () => {
        ...
        expect(body.images).toEqual([Buffer.from(new Uint8Array([9, 9, 9])).toString("base64")]);
