    ...
    return (
        <div
            ...
            style={{
                background: "var(--bg)",
                color: "var(--ink)",
                ...(embedded ? { height: "100%", overflowY: "auto" } : { minHeight: "100vh" }),
                display: "flex",
...
export const Button = forwardRef<HTMLButtonElement, PrimaryButtonProps>(function Button(
    ...
    return (
        <button ref={ref} {...props} style={{ ...base, ...variants[variant], ...style }}>
            {children}
        </button>
    );
});
