...
const CONNECTORS = [
    {
        name: "Gmail",
        desc: "Threads, labels, attachments. Scope by label.",
        tag: "Planned",
        soon: true,
    },
    ...
    {
        name: "Google Drive",
        desc: "Docs, Sheets, PDFs — folder-scoped.",
        tag: "Planned",
        soon: true,
    },
    {
        name: "Slack",
        desc: "Channels + DMs. Pick what\u2019s in scope.",
        tag: "Planned",
        soon: true,
    },
    ...
    {
        name: "Calendar",
        desc: "Events + attendees give calls context.",
        tag: "Planned",
        soon: true,
    },
];
...
const FORMATS: Array<{
    ext: string;
    name: string;
    kind: "doc" | "audio" | "video" | "image" | "code" | "data";
}> = [
        ...
        <section className={styles.hero}>
            ...
            <div className={styles.heroCopy}>
                ...
                <p className={styles.heroSub}>
                    The open-source knowledge graph for founders. Ask once. Get cited answers.
                </p>
    ...
    useEffect(() => {
        ...
        const refreshScope = () => {
            ...
            if (chipCountRef.current)
                chipCountRef.current.textContent = n === 1 ? "1 source" : `${n} sources`;
        };
        ...
        <div className={styles.stage}>
            ...
            <div className={styles.stageCount}>
                <span className={styles.chip}>
                    <b ref={scopeCountRef}>0</b> in scope
                </span>
            </div>
...
const KP_SOURCES: KpCard[] = [
    ...
    { id: "images", label: "Images & scans", meta: "ocr on upload", y: 640, Icon: IconImage },
    {
        id: "github",
        label: "Repos & ZIPs",
        meta: "github import · zip fan-out",
        y: 780,
        Icon: IconGithub,
    },
];
        ...
        <section id="pipeline" className={styles.section}>
            <div className={styles.container}>
                ...
                <p className={styles.lead}>
                    Uploads, recordings, images, and repository imports flow through one ingestion
                    pipeline — OCR, transcription, chunking, embeddings — into Postgres + pgvector
                    and a knowledge graph. Every feature that answers a question queries the same
    ...
    return (
        <>
            ...
            <div className="kp-eyebrow kp-eyebrow--src" style={{ left: kpPctX(KP_SRC_X) }}>
                <span className="kp-eyebrow__line" />
                Sources
            </div>
...
function IconPDF() {
    return (
        <svg viewBox="0 0 20 22" fill="none" aria-hidden>
            <path
                d="M3 1h10l4 4v15a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"
                fill="#fff"
                stroke="#d0d0d0"
            />
...
function IconMegaphone() {
    return (
        <svg viewBox="0 0 24 24" fill="none" aria-hidden>
            <path
                d="M4 10v4a1 1 0 0 0 1 1h3l9 4V5L8 9H5a1 1 0 0 0-1 1z"
                fill="oklch(0.96 0.04 30)"
                stroke="oklch(0.55 0.2 30)"
                strokeWidth={1.4}
                strokeLinejoin="round"
            />
            <path
                d="M19.5 9.5a4 4 0 0 1 0 5"
                stroke="oklch(0.55 0.2 30)"
                strokeWidth={1.5}
                strokeLinecap="round"
                fill="none"
        ...
        <section className={styles.section}>
            <div className={styles.container}>
                ...
                <h2 className={styles.h2}>
                    Your best thinking is <span className={styles.serif}>stranded</span> across
                    eight apps.
                </h2>
                <p className={styles.lead}>
                    You took the meeting. You saved the PDF. You wrote the Notion doc. But when you
                    need to answer &ldquo;what did our users actually care about?&rdquo; —
                    it&rsquo;s buried. Launchstack fixes the last mile.
                </p>
    ...
    return (
        <section id="features" className={styles.section}>
            <div className={styles.container}>
                ...
                <p className={styles.lead}>
                    Drag in files of almost any format — transcription, OCR, and chunking are
                    handled automatically. App connectors are on the roadmap; today everything comes
                    in through upload and import.
                </p>
                ...
                <div style={sourcesShellInline}>
                    <div style={sourcesTabsInline}>
                        ...
                        >
                            <Link2 size={14} />
                            Connectors{" "}
                            <span style={countStyle(tab === "connectors")}>
                                {CONNECTORS.length}
                            </span>
                        </button>
                        <button
                        ...
                        >
                            <FileText size={14} />
                            File formats{" "}
                            <span style={countStyle(tab === "formats")}>{FORMATS.length}+</span>
                        </button>
                    </div>
    ...
    const steps = [
        {
            ...
            desc: "Drag in files, ZIP archives, call recordings, or a GitHub repo URL. Launchstack handles OCR, transcription, and indexing.",
        },
        {
            n: "02",
            title: "Check what matters",
            desc: "Your sources appear in a clean rail. Tick the ones you want in scope for this question. Leave the rest alone.",
        },
        {
            n: "03",
            title: "Ask. Get cited answers.",
            desc: "Type your question in plain English. Launchstack synthesizes across every checked source — and every claim links to the exact paragraph or timestamp.",
        },
    ];
    return (
        <section id="how" className={styles.section}>
            <div className={styles.container}>
                ...
                <p className={styles.lead}>
                    Drop in, check what matters, ask. The animation above is an illustration of that
                    flow.
                </p>
    ...
    const list = [
        {
            ...
            body: "Upload \u2192 transactional outbox \u2192 worker \u2192 OCR / transcription \u2192 chunking \u2192 embeddings. Every document takes the same durable path into Postgres + pgvector.",
        },
        {
            title: "Cited answers",
            body: "Ask across the sources you select. Retrieval combines vector and keyword search, and every claim in the answer links back to the passage it came from.",
        },
        {
            title: "Runs on your infrastructure",
            body: "A Docker Compose stack: Next.js app, worker, Postgres + pgvector, S3-compatible storage, and compute services for transcription, document conversion, and DOCX editing.",
        },
    ];
    return (
        <section className={styles.section}>
    ...
    return (
        <section id="pricing" className={styles.section}>
            <div className={styles.container}>
                ...
                <p className={styles.lead}>
                    Launchstack is free, Apache 2.0–licensed software. Self-hosting is the offering:
                    run the whole stack on your own infrastructure with your own API keys. A managed
                    cloud version is on the roadmap — there is no paid plan and no billing yet.
                </p>
            ...
            <div className={styles.container}>
                <div className={styles.oss}>
                    <div>
                        ...
                        <h3>
                            The engine is <span className={styles.serif}>open source.</span> Read
                            it. Fork it. Run it.
                        </h3>
                        <p>
                            The whole system lives on GitHub under Apache 2.0 — the Next.js app, the
                            worker that runs the pipeline, the TypeScript retrieval engine, and the
                            compute services. Audit the prompts, swap the model, self-host the whole
                            thing.
                        </p>
                    ...
                    <div className={styles.ossCard} aria-hidden>
                        <div className={styles.ossCardHd}>
                            ...
                            <span className="slash" style={{ color: "var(--ink-4)" }}>
                                /
                            </span>
                            <span className="repo" style={{ fontWeight: 600, color: "var(--ink)" }}>
                                LaunchStack
...
function TreeRow({ name, comment, nested }: { name: string; comment: string; nested?: boolean }) {
    return (
        <div
            className={`row ${nested ? styles.rowNested : ""}`}
            style={{ display: "flex", alignItems: "center", gap: 8, paddingLeft: nested ? 16 : 0 }}
        >
            ...
            <span
                className="comment"
                style={{ color: "var(--ink-3)", marginLeft: "auto", fontSize: 11 }}
            >
                {comment}
            </span>
        </div>
...
function FinalCta() {
    return (
        <div className={styles.finalCta}>
            ...
            <h2 className={styles.h2}>
                It takes <span className={styles.serif}>90 seconds</span> to feel the difference.
            </h2>
            <p>
                Drop in a few sources, ask one question, watch it answer with citations.
                Self-hosted, everything stays on your own infrastructure.
            </p>
            <div className={styles.heroCtas}>
                <a
                    href={SIGN_UP_URL}
