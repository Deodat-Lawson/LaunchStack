...
export function RewriteDiffView() {
    ...
    return (
        <div className="flex h-full flex-col">
            {/* Hero header */}
            <div className="flex-shrink-0 px-6 pb-4 pt-8 md:px-10 md:pt-10">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className={s.sub} style={{ maxWidth: 560 }}>
                                    Paste or import text, pick a tone, preview the changes, then
                                    push the polished version into your editor.
                                </p>
                            </div>
                        </div>
                                ...
                                <div className="flex flex-col gap-4 md:flex-row md:items-center">
                                    <div className="flex flex-1 items-start gap-3">
                                        ...
                                        <div className="min-w-0 space-y-1">
                                            ...
                                            >
                                                Paste or drop in text, choose tone / length /
                                                audience, preview the diff, then push to your
                                                document.
                                            </p>
                                        </div>
                                    </div>
