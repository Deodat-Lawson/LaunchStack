...
describe("unsubscribe tokens", () => {
    it("round-trips the company and address it was issued for", () => {
        const token = createUnsubscribeToken({ companyId: 42, email: "Person@Example.com" }, env);
    ...
    it("rejects a token signed with a different secret", () => {
        const token = createUnsubscribeToken({ companyId: 42, email: "person@example.com" }, other);
