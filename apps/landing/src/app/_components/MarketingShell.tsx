        ...
        <footer className={styles.footer}>
            <div>
                ...
                <p className={styles.footTag}>
                    The open-source launch stack for tech founders. Document AI, growth tools, and
                    team management — built by founders, for founders.
                </p>
            </div>
            <div>
                <h5>Product</h5>
                <ul>
                    ...
                    <li>
                        <a href={SIGN_UP_URL} rel="noopener">
                            Try it free
                        </a>
                    </li>
                </ul>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>
                        <Link href="/deployment">Self-host guide</Link>
                    </li>
                    <li>
                        <a
