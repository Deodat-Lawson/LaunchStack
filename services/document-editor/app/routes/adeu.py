...
Wire formats frozen: packages/protocol/schemas/v1/document-editor.*.schema.json
...
# Authentication now lives in app/auth.py so the transcription routes share the
# same dependency — see the module docstring there for why it is not in this file.
