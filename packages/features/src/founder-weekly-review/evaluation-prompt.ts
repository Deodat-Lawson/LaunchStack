...
export const FOUNDER_WEEKLY_REVIEW_EVALUATION_PROMPT_VERSION =
    "founder-weekly-review-evaluation/v2" as const;
export function buildFounderWeeklyReviewEvaluationPrompt(
