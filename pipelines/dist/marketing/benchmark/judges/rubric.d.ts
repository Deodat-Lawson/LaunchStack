...
export declare const JUDGE_CRITERIA: readonly ["groundedness", "specificity", "brand_voice", "audience_relevance", "goal_alignment", "platform_structure", "hook_strength", "cta_quality", "cliche_generic", "citation_coverage"];
...
export declare const JudgeCriterionScoreSchema: z.ZodObject<{
    criterion: z.ZodEnum<["groundedness", "specificity", "brand_voice", "audience_relevance", "goal_alignment", "platform_structure", "hook_strength", "cta_quality", "cliche_generic", "citation_coverage"]>;
    score: z.ZodNumber;
    rationale: z.ZodString;
}, "strip", z.ZodTypeAny, {
    rationale: string;
    criterion: "brand_voice" | "groundedness" | "specificity" | "audience_relevance" | "goal_alignment" | "platform_structure" | "hook_strength" | "cta_quality" | "cliche_generic" | "citation_coverage";
    score: number;
}, {
    rationale: string;
    criterion: "brand_voice" | "groundedness" | "specificity" | "audience_relevance" | "goal_alignment" | "platform_structure" | "hook_strength" | "cta_quality" | "cliche_generic" | "citation_coverage";
...
export declare const JudgeResultSchema: z.ZodObject<{
    scores: z.ZodEffects<z.ZodArray<z.ZodObject<{
        criterion: z.ZodEnum<["groundedness", "specificity", "brand_voice", "audience_relevance", "goal_alignment", "platform_structure", "hook_strength", "cta_quality", "cliche_generic", "citation_coverage"]>;
        score: z.ZodNumber;
        rationale: z.ZodString;
    }, "strip", z.ZodTypeAny, {
