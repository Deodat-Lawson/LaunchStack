...
function buildConfig(): CoreConfig {
    ...
    const documentConverterUrl = server.DOCUMENT_CONVERTER_URL ?? server.OCR_ROUTER_URL;
    ...
    return {
        ...
        ocr: {
            ...
            azure:
                server.AZURE_DOC_INTELLIGENCE_ENDPOINT && server.AZURE_DOC_INTELLIGENCE_KEY
                    ? {
