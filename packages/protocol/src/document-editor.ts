...
export type ApplyEditsMarkdownRequest = z.infer<
  typeof applyEditsMarkdownRequestSchema
>;

export const applyEditsMarkdownResponseSchema = z.object({
  markdown: z.string(),
});
export type ApplyEditsMarkdownResponse = z.infer<
  typeof applyEditsMarkdownResponseSchema
>;
