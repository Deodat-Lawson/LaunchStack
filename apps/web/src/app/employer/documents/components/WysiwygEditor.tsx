...
export const WysiwygEditor = forwardRef<WysiwygEditorHandle, WysiwygEditorProps>(
    function WysiwygEditor(
        { initialContent, onChange, onSelectionChange, placeholder: _placeholder, className },
        ref
    ) {
        ...
        useImperativeHandle(
            ...
            () => ({
                ...
                getExtractedAtCursor: () => {
                    ...
                    const { from: fromPos, to: toPos } = findPositions(
                        doc,
                        extracted.start,
                        extracted.end
                    );
                ...
                replaceRangeByTextContext: (
                    ...
                    editor
                        .chain()
                        .focus()
                        .insertContentAt({ from, to }, content || proposedText)
                        .run();
                    return true;
                },
