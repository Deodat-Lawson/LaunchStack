...
export function getFilesToExploreSystem(diagramType = "architecture") {
...
`;
export function buildFilesToExploreUserPrompt(tree) {
...
export function buildUserPrompt(repo, repoContext, userInstructions) {
