 ...
 */
export declare function buildChunkExtractionPrompt(
    documentName: string,
    chunkContent: string,
    batchIndex: number,
    totalBatches: number
