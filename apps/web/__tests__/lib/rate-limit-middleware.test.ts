...
describe("Rate Limit Middleware", () => {
    ...
    describe("withRateLimit", () => {
        it("should allow request within rate limit", async () => {
            ...
            const handler = jest.fn(async () => NextResponse.json({ success: true, data: "test" }));
        ...
        it("should work with rate limit presets", async () => {
            ...
            const response = await withRateLimit(request, RateLimitPresets.standard, handler);
    ...
    describe("Integration with API Routes", () => {
        it("should rate limit expensive operations more strictly", async () => {
            ...
            const blocked = await withRateLimit(request, RateLimitPresets.strict, expensiveHandler);
