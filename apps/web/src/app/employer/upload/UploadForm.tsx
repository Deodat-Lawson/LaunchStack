...
const UploadForm: React.FC<UploadFormProps> = ({
            ...
            ? [
                  {
                      ...
                      label: "Auto",
                      description:
                          "Automatically select the best method based on document analysis.",
                  },
              ]
            : []),
            ...
            ? [
                  {
                      value: "azure",
                      label: "Azure OCR",
                      description: "Azure Document Intelligence OCR",
                  },
              ]
            : []),
        ...(availableProviders.landingAI
            ...
            if (zipArchiveCount > 0) {
                if (zipQueuedCount > 0) {
                    toast.success("ZIP archive queued", {
                        description:
                            "Files will be auto-extracted and processed individually after upload.",
                    });
                }
    ...
    const currentStorageValue = useUploadThing && isUploadThingConfigured ? "cloud" : "database";
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            {documents.length > 0 && (
                <FileQueue
                    ...
                    onToggleExpand={id => setExpandedDocId(expandedDocId === id ? null : id)}
                ...
                <div style={{ display: "flex", justifyContent: "flex-end" }}>
                    <button
                        ...
                        style={{
                            ...
                            fontWeight: 600,
                            border: "none",
                            cursor: isSubmitting || pendingCount === 0 ? "not-allowed" : "pointer",
                            boxShadow:
                                isSubmitting || pendingCount === 0
                                    ? "none"
