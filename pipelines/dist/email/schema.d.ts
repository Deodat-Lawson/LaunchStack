 ...
 */
export declare const emailCampaigns: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        approvedVersionId: import("drizzle-orm/pg-core").PgColumn<
            ...
            {}
        >;
        automationKey: import("drizzle-orm/pg-core").PgColumn<
            {
                name: "automation_key";
                tableName: "email_campaigns";
                dataType: "string";
...
export declare const emailTemplateVersions: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        >;
        reviewVerdict: import("drizzle-orm/pg-core").PgColumn<
            {
                name: "review_verdict";
                tableName: "email_template_versions";
                dataType: "string";
 ...
 */
export declare const emailCampaignApprovals: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "email_campaign_approvals";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<
            {
                name: "id";
                tableName: "email_campaign_approvals";
                dataType: "number";
                columnType: "PgSerial";
                data: number;
                driverParam: number;
        ...
        approvedBy: import("drizzle-orm/pg-core").PgColumn<
            ...
            {}
        >;
        approvedByEmail: import("drizzle-orm/pg-core").PgColumn<
            {
        ...
        >;
        approvedByKind: import("drizzle-orm/pg-core").PgColumn<
            {
                name: "approved_by_kind";
                tableName: "email_campaign_approvals";
                dataType: "string";
                columnType: "PgVarchar";
                data: string;
 ...
 * address twice.
 */
export declare const emailRecipients: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        >;
        contextNotes: import("drizzle-orm/pg-core").PgColumn<
            {
                name: "context_notes";
                tableName: "email_recipients";
                dataType: "string";
 ...
 */
export declare const emailSendAttempts: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        failedCount: import("drizzle-orm/pg-core").PgColumn<
            ...
            {}
        >;
        suppressedCount: import("drizzle-orm/pg-core").PgColumn<
            {
 ...
 * sending one is not.
 */
export declare const emailSends: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "email_sends";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<
        ...
        >;
        providerIdempotencyKey: import("drizzle-orm/pg-core").PgColumn<
            {
...
export declare const emailSuppressions: import("drizzle-orm/pg-core").PgTableWithColumns<{
