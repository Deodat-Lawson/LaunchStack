...
async function makeTextPdf(): Promise<Uint8Array> {
    ...
    page.drawText("This is a digitally generated PDF document with a fully extractable", {
        x: 40,
        y: 300,
        size: 12,
        font,
    });
    page.drawText("text layer used to exercise the native text-layer routing path.", {
        x: 40,
        y: 280,
        size: 12,
        font,
