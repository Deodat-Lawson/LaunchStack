...
import { index, jsonb, timestamp, varchar, bigint, uniqueIndex, bigserial, } from "drizzle-orm/pg-core";
...
// ============================================================================
export const companyMetadataHistory = pgTable("company_metadata_history", {
    id: bigserial("id", { mode: "number" }).primaryKey(),
    companyId: bigint("company_id", { mode: "bigint" })
        .notNull()
        .references(() => company.id, { onDelete: "cascade" }),
