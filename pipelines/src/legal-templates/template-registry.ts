...
export const TEMPLATE_REGISTRY: Record<string, LegalTemplate> = {
    ...
    nda: {
        ...
        fields: [
            ...
            {
                key: "disclosing_party_jurisdiction",
                label: "Disclosing Party Jurisdiction",
                type: "text",
                required: true,
            },
            {
            ...
            {
                key: "receiving_party_jurisdiction",
                label: "Receiving Party Jurisdiction",
                type: "text",
                required: true,
            },
            {
            ...
            {
                key: "confidential_info_description",
            ...
            },
            {
                ...
                label: "Disclosing Party Signatory",
                type: "text",
                required: true,
            },
            {
                key: "disclosing_party_signatory_title",
                label: "Disclosing Signatory Title",
                type: "text",
                required: true,
            },
            {
                key: "receiving_party_signatory",
                label: "Receiving Party Signatory",
                type: "text",
                required: true,
            },
            {
                key: "receiving_party_signatory_title",
                label: "Receiving Signatory Title",
                type: "text",
                required: true,
            },
    ...
    founders_agreement: {
        ...
        fields: [
            ...
            {
                key: "founder_1_equity_pct",
                label: "Founder 1 Equity (%)",
                type: "number",
                required: true,
            },
            {
                key: "founder_1_capital",
                label: "Founder 1 Capital Contribution",
                type: "text",
                required: true,
            },
            ...
            {
                key: "founder_2_equity_pct",
                label: "Founder 2 Equity (%)",
                type: "number",
                required: true,
            },
            {
                key: "founder_2_capital",
                label: "Founder 2 Capital Contribution",
                type: "text",
                required: true,
            },
            {
            ...
            { key: "cliff_months", label: "Cliff Period (months)", type: "number", required: true },
            {
                ...
                type: "select",
                required: true,
                options: ["majority", "unanimous", "board"],
            },
            {
    ...
    ip_assignment: {
        ...
        fields: [
            ...
            {
                key: "consideration",
                label: "Consideration / Compensation",
                type: "text",
                required: true,
            },
            {
            ...
            {
                key: "assignor_signatory",
                label: "Assignor Signatory Name",
                type: "text",
                required: true,
            },
            { key: "signature_date", label: "Signature Date", type: "date", required: true },
    ...
    service_agreement: {
        ...
        fields: [
            ...
            { key: "payment_amount", label: "Payment Amount", type: "text", required: true },
            {
                ...
                type: "select",
                required: true,
                options: ["monthly", "milestone", "upon_completion", "net_30"],
            },
            ...
            },
            {
                ...
                type: "select",
                required: true,
                options: ["client", "provider", "shared"],
            },
    ...
    contractor_agreement: {
        ...
        fields: [
            ...
            },
            {
                ...
                type: "select",
                required: true,
                options: ["hourly", "fixed_project", "retainer"],
            },
            {
                key: "payment_terms",
                label: "Payment Terms",
                type: "select",
                required: true,
                options: ["net_15", "net_30", "upon_completion", "biweekly"],
            },
            ...
            },
            {
                ...
                type: "select",
                required: true,
                options: ["company", "contractor", "shared"],
            },
            {
    ...
    advisory_agreement: {
        ...
        fields: [
            ...
            {
                key: "advisor_signatory",
                label: "Advisor Signatory Name",
                type: "text",
                required: true,
            },
            {
                key: "company_signatory",
    ...
    employment_contract: {
        ...
        fields: [
            ...
            { key: "reporting_to", label: "Reports To", type: "text", required: true },
            {
                ...
                type: "select",
                required: true,
                options: ["full_time", "part_time", "temporary"],
            },
            ...
            { key: "salary_amount", label: "Salary Amount", type: "text", required: true },
            {
                ...
                type: "select",
                required: true,
                options: ["annually", "monthly", "biweekly"],
            },
    ...
    employee_nda: {
        ...
        fields: [
            ...
            {
                key: "exclusions",
                label: "Exclusions from Confidentiality",
                type: "textarea",
                required: true,
            },
            {
                key: "obligations_duration_years",
                label: "Obligations Duration (years)",
                type: "number",
                required: true,
            },
            {
                key: "return_of_materials_days",
                label: "Return of Materials (days)",
                type: "number",
                required: true,
            },
            {
                key: "non_solicitation_months",
    ...
    invention_assignment: {
        ...
        fields: [
            ...
            { key: "employee_title", label: "Employee Title", type: "text", required: true },
            {
                key: "scope_of_inventions",
                label: "Scope of Inventions Covered",
                type: "textarea",
                required: true,
            },
            {
                key: "prior_inventions",
                label: "Prior Inventions Excluded",
                type: "textarea",
                required: true,
            },
            {
            ...
            {
                key: "employee_signatory",
                label: "Employee Signatory Name",
                type: "text",
                required: true,
            },
            { key: "signature_date", label: "Signature Date", type: "date", required: true },
    ...
    non_compete: {
        ...
        fields: [
            ...
            {
                key: "non_solicitation_months",
                label: "Non-Solicitation Duration (months)",
                type: "number",
                required: true,
            },
            {
                key: "non_solicitation_scope",
                label: "Non-Solicitation Scope",
                type: "textarea",
                required: true,
            },
            { key: "consideration", label: "Consideration", type: "text", required: true },
            {
                key: "garden_leave_months",
                label: "Garden Leave Period (months)",
                type: "number",
                required: false,
            },
            {
                key: "enforcement_mechanism",
                label: "Enforcement Mechanism",
                type: "select",
                required: true,
                options: ["injunctive_relief", "liquidated_damages", "both"],
            },
            {
                key: "governing_law_jurisdiction",
                label: "Governing Law Jurisdiction",
    ...
    privacy_policy: {
        ...
        fields: [
            ...
            { key: "user_rights", label: "User Rights", type: "textarea", required: true },
            {
                ...
                type: "select",
                required: true,
                options: ["collects_under_13", "does_not_collect"],
            },
            {
                key: "dpo_contact",
    ...
    terms_of_service: {
        ...
        fields: [
            ...
            {
                key: "user_content_rights",
                label: "User Content Rights",
                type: "select",
                required: true,
                options: ["user_retains", "company_license", "company_owns"],
            },
            {
            ...
            },
            {
                ...
                type: "select",
                required: true,
                options: ["arbitration", "litigation", "mediation"],
            },
            {
                key: "governing_law_jurisdiction",
                label: "Governing Law Jurisdiction",
    ...
    termination_letter: {
        ...
        fields: [
            ...
            {
                key: "final_paycheck_date",
                label: "Final Paycheck Date",
                type: "date",
                required: true,
            },
            {
                key: "return_of_property_date",
                label: "Return of Property By",
                type: "date",
                required: true,
            },
    ...
    severance_agreement: {
        ...
        fields: [
            ...
            {
                key: "severance_schedule",
                label: "Severance Payment Schedule",
                type: "select",
                required: true,
                options: ["lump_sum", "installments", "salary_continuation"],
            },
            {
                key: "severance_duration_months",
                label: "Severance Duration (months)",
                type: "number",
                required: true,
            },
            {
                key: "benefits_continuation_months",
                label: "Benefits Continuation (months)",
                type: "number",
                required: true,
            },
            {
                key: "equity_treatment",
                label: "Equity Treatment",
                type: "textarea",
                required: true,
            },
            {
                key: "outplacement_services",
            ...
            },
            {
                ...
                type: "select",
                required: true,
                options: ["mutual", "one_way", "none"],
            },
            {
                key: "non_compete_months",
                label: "Post-Separation Non-Compete (months)",
                type: "number",
                required: true,
            },
            {
            ...
            {
                key: "consideration_period_days",
                label: "Consideration Period (days)",
                type: "number",
                required: true,
            },
            {
                key: "revocation_period_days",
                label: "Revocation Period (days)",
                type: "number",
                required: true,
            },
            {
