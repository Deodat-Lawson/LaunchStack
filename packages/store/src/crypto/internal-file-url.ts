 ...
 */
export function buildInternalFileUrl(appPublicUrl: string, fileId: number | string): string {
...
export function originsEqual(url: string, appPublicUrl: string | undefined): boolean {
 ...
 */
export function isInternalFileUrl(url: string, appPublicUrl: string | undefined): boolean {
