...
export declare const PlatformMetaSchema: z.ZodOptional<
    z.ZodObject<
        {
    ...
    >
>;
export declare const FormalityLevelEnum: z.ZodEnum<
    ["formal", "conversational", "technical", "bold"]
>;
