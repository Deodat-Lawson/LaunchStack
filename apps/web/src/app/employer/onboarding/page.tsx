        ...
        <>
            <div style={{ padding: "32px 30px 24px" }}>
                ...
                <div style={{ fontSize: 14, color: "var(--ink-3)", lineHeight: 1.55 }}>
                    Launchstack pulls your docs, notes, transcripts, and repos into one place you
                    can ask anything. A couple of short steps and you&apos;re live.
                </div>
    ...
    return (
        <>
            <div style={{ padding: "32px 30px 24px" }}>
                ...
                >
                    This description feeds into every AI call — sharper context here means sharper
                    answers everywhere. Skip if you&apos;d rather set it up later.
                </div>
