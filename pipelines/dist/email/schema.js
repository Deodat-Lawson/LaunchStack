...
import { bigint, index, integer, jsonb, serial, text, timestamp, uniqueIndex, varchar, } from "drizzle-orm/pg-core";
...
export const emailCampaigns = pgTable("email_campaigns", {
     ...
     */
    approvedVersionId: integer("approved_version_id").references(() => emailTemplateVersions.id, { onDelete: "set null" }),
    /**
 ...
 */
export const emailCampaignApprovals = pgTable("email_campaign_approvals", {
    id: serial("id").primaryKey(),
    campaignId: integer("campaign_id")
        .notNull()
        .references(() => emailCampaigns.id, { onDelete: "cascade" }),
