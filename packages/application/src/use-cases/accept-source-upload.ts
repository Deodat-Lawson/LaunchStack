...
export function createAcceptSourceUpload(deps: AcceptSourceUploadDeps) {
    return {
        async acceptSource(cmd: CreateSourceCommand): Promise<SourceLifecycleResult> {
        ...
        async acceptSourceVersion(cmd: CreateSourceVersionCommand): Promise<SourceLifecycleResult> {
