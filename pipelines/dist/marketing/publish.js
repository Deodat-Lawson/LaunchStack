...
async function publishToBluesky(message) {
...
async function publishToReddit(message, title) {
 ...
 */
async function resolveLinkedInPersonId(token) {
    try {
 ...
 */
export async function publishContent(platform, message, title) {
