 ...
 *
 * Runs the LLM-based NER provider over document chunks and stores the
 * results in the knowledge graph tables. (The sidecar /extract-entities
 * path was removed by ADR-004 §5 — no service ever implemented it.)
 */
...
import { getNERProvider } from "@launchstack/llm/providers/ner";
...
/**
 * Extract entities from chunks via the LLM NER provider and persist them
