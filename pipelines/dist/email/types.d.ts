...
export declare const ReviewCriterionEnum: z.ZodEnum<["grounding", "clarity", "tone", "spam_risk", "cta_strength", "compliance"]>;
...
export declare const TemplateReviewSchema: z.ZodObject<{
    scores: z.ZodArray<z.ZodObject<{
        criterion: z.ZodEnum<["grounding", "clarity", "tone", "spam_risk", "cta_strength", "compliance"]>;
        score: z.ZodNumber;
 ...
 */
export declare const CampaignStatusEnum: z.ZodEnum<["draft", "needs_revision", "pending_approval", "approved", "sending", "sent", "failed"]>;
