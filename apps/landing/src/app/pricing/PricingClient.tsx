    ...
    <MarketingShell>
      <section className={styles.pageHero}>
        ...
        <p className={styles.pageSub}>
          Launchstack is fully open source under Apache 2.0. Self-hosting is
          the offering: run the entire stack on your own infrastructure with
          your own API keys, at whatever scale your hardware allows. A managed
          cloud version is on the roadmap — there is no paid plan and no
          billing yet.
        </p>
        <div className={styles.heroCtas}>
          <Link href="/deployment" className={`${styles.btn} ${styles.btnAccent} ${styles.btnLg}`}>
            Deployment guide
            <ArrowRight size={16} />
          </Link>
          <a
